...
unpackers[0xC0] = function () return nil end
unpackers[0xC2] = function () return false end
unpackers[0xC3] = function () return true end
unpackers[0xC4] = function (c) return unpack_str(c, unpack_uint8(c)) end
unpackers[0xC5] = function (c) return unpack_str(c, unpack_uint16(c)) end
unpackers[0xC6] = function (c) return unpack_str(c, unpack_uint32(c)) end
unpackers[0xC7] = function (c) return unpack_ext(c, unpack_uint8(c), unpack_int8(c)) end
unpackers[0xC8] = function (c) return unpack_ext(c, unpack_uint16(c), unpack_int8(c)) end
unpackers[0xC9] = function (c) return unpack_ext(c, unpack_uint32(c), unpack_int8(c)) end
unpackers[0xCA] = unpack_float
unpackers[0xCB] = unpack_double
unpackers[0xCC] = unpack_uint8
unpackers[0xCD] = unpack_uint16
unpackers[0xCE] = unpack_uint32
unpackers[0xCF] = unpack_uint64
unpackers[0xD0] = unpack_int8
unpackers[0xD1] = unpack_int16
unpackers[0xD2] = unpack_int32
unpackers[0xD3] = unpack_int64
unpackers[0xD4] = function (c) return unpack_ext(c, 1, unpack_int8(c)) end
unpackers[0xD5] = function (c) return unpack_ext(c, 2, unpack_int8(c)) end
unpackers[0xD6] = function (c) return unpack_ext(c, 4, unpack_int8(c)) end
unpackers[0xD7] = function (c) return unpack_ext(c, 8, unpack_int8(c)) end
unpackers[0xD8] = function (c) return unpack_ext(c, 16, unpack_int8(c)) end
unpackers[0xD9] = function (c) return unpack_str(c, unpack_uint8(c)) end
unpackers[0xDA] = function (c) return unpack_str(c, unpack_uint16(c)) end
unpackers[0xDB] = function (c) return unpack_str(c, unpack_uint32(c)) end
unpackers[0xDC] = function (c) return unpack_array(c, unpack_uint16(c)) end
unpackers[0xDD] = function (c) return unpack_array(c, unpack_uint32(c)) end
unpackers[0xDE] = function (c) return unpack_map(c, unpack_uint16(c)) end
unpackers[0xDF] = function (c) return unpack_map(c, unpack_uint32(c)) end
